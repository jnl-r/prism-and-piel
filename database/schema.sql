...
-- ---------- 3. Product (brand_name is a plain attribute) ----------
...
-- ---------- 4. ProductVariant (weak entity: PK = product_id + variant_id) ----------
...
CREATE TABLE AffiliateLink (
  ...
  FOREIGN KEY (product_id, variant_id)
    REFERENCES ProductVariant(product_id, variant_id) ON DELETE CASCADE
);
