...
-- 2. SkinProfiles (2 per user, with profile_label)
...
-- 3. Products (brand_name as attribute)
...
-- 5. AffiliateLinks (variant_id only)
INSERT INTO AffiliateLink (variant_id, affiliate_url, click_count) VALUES
(1, 'https://tiktokshop.com/blk-warm-beige?aff=prism001', 0),
(2, 'https://tiktokshop.com/blk-golden-tan?aff=prism001', 0),
(1, 'https://tiktokshop.com/maybelline-natural-beige?aff=prism001', 0),
(1, 'https://tiktokshop.com/maybelline-dusty-rose?aff=prism001', 0),
(1, 'https://tiktokshop.com/absidy-honey-glow?aff=prism001', 0),
(1, 'https://tiktokshop.com/happyskin-coral-bliss?aff=prism001', 0);

-- 6. Reviews (variant_id only)
INSERT INTO Review (user_id, variant_id, rating, comment, skin_profile_match) VALUES
(1, 1, 4.5, 'Great coverage, stays all day on oily skin!', TRUE),
(2, 1, 4.0, 'Lightweight and natural finish, love it!', TRUE),
(3, 2, 5.0, 'Perfect shade for my tan skin!', TRUE),
(4, 1, 3.5, 'Good hydration but oxidizes a little', FALSE),
(5, 2, 4.5, 'The terracotta shade is so flattering!', TRUE);

-- 7. RecommendationLog (variant_id only)
INSERT INTO RecommendationLog (user_id, variant_id, rank_position, clicked) VALUES
(1, 1, 1, TRUE),
(1, 2, 2, FALSE),
(2, 1, 1, TRUE),
(3, 2, 1, FALSE),
